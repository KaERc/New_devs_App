...
export const RevenueSummary: React.FC<RevenueSummaryProps> = ({ propertyId = 'prop-001', debugTenant, showRaw }) => {
    ...
    // The backend already rounds to whole cents with Decimal before
    // sending this value - avoid re-deriving cents from float math here,
    // since that's exactly how "off by a few cents" bugs creep back in.
